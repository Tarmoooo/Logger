...
int main(int argc, char *argv[])
{
    ...
    const int plantNo = 1;
    const std::string plantsPath = "C:/Users/Admin/Documents/PROJECT C++ Programmeerimine/src/IAS0410Plants.txt"; // put TXT next to main.exe

    // 1) Load DLL (put DLL next to main.exe)
    HMODULE h = LoadLibraryA("C:/Users/Admin/Documents/PROJECT C++ Programmeerimine/src/IAS0410PlantEmulator.dll");
    if (!h) {
